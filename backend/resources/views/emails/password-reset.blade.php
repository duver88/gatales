...
<head>
    ...
    <title>Restablecer contraseña - El Cursales</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #CCCCCC; font-size: 16px; line-height: 1.6;">
                                Recibimos una solicitud para restablecer la contraseña de tu cuenta en El Cursales.
                            </p>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    <td align="center" style="padding: 20px 0;">
                                        <a href="{{ $resetPasswordUrl }}" style="display: inline-block; padding: 16px 40px; background-color: #00be88; color: #FFFFFF; text-decoration: none; font-size: 16px; font-weight: 600; border-radius: 8px;">
                            ...
                            <p style="margin: 30px 0 0 0; color: #888888; font-size: 14px; line-height: 1.6;">
                                Este enlace expirara en 1 hora. Si no solicitaste restablecer tu contraseña, puedes ignorar este correo de forma segura.
                            </p>
